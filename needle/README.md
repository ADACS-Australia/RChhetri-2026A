...
- `models/` - Models are data structure models that are used by Needle. These models must be created to do meaningful work.
...
\* Not all tasks and modules can practically work this way... Work in Progress!

## Flow design

Flows are blocking, while tasks run concurrently where possible. So it is not desirable to break up a flow into many smaller flows unless absolutely necessary.

Instead, use tasks as much as possible and make them as plug-and-play as possible.
